...
import { Download, X, Smartphone, CheckCircle2, Share2, HelpCircle } from 'lucide-react';
...
export default function InstallPrompt() {
  ...
  useEffect(() => {
    ...
    if (isStandalone) {
      localStorage.setItem('kirti_admin_pwa_installed', 'true');
      return;
    }
    ...
    const handler = (e) => {
      ...
      const dismissed = localStorage.getItem('kirti_admin_pwa_dismissed');
    ...
    if (isAppleDevice) {
      ...
      // Fallback: If beforeinstallprompt hasn't fired after 2 seconds (e.g. Chrome mini-bar delayed)
  ...
  const handleInstallClick = async () => {
    ...
    if (promptEvent) {
      ...
      // If native prompt not available, show step-by-step instructions
  ...
  const handleDismiss = () => {
    ...
    localStorage.setItem('kirti_admin_pwa_dismissed', String(Date.now()));
  };
  ...
  if (installedNotice) {
    return (
      <div style={{
        ...
        <span>🎉 Kirti Admin App Installed! Launch anytime directly from your Home Screen.</span>
      </div>
    );
  }
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '11px', color: '#C7D2FE', fontWeight: '500' }}>
              One-tap access & fast offline control
            </div>
          </div>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '6px' }}>
                <span style={{ background: '#4F46E5', color: '#FFF', borderRadius: '50%', width: '18px', height: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold' }}>1</span>
                <span>Open browser menu (⋮ or ⎋)</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ background: '#4F46E5', color: '#FFF', borderRadius: '50%', width: '18px', height: '18px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '10px', fontWeight: 'bold' }}>2</span>
