...
- [x] Fixed **Start Time & End Time Inputs** in `BookingPortal.jsx`: Removed redundant left clock icons to eliminate duplicate clock icons and attached live 12-hour AM/PM formatted badges (e.g. `04:00 PM` & `05:00 PM`) above inputs when slots are selected.
