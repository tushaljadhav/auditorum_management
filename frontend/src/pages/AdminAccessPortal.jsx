...
import {
  ...
  Share2, QrCode, ShieldCheck
} from 'lucide-react';
import { setAdminAuthorized } from '../utils/adminAuth';
...
export default function AdminAccessPortal() {
  ...
  useEffect(() => {
    ...
    const storedInstalled = localStorage.getItem('kirti_admin_app_installed') === 'true';
    ...
    const handleAppInstalled = () => {
      setIsInstalled(true);
      localStorage.setItem('kirti_admin_app_installed', 'true');
  ...
  const handleResetInstallState = (e) => {
    e.preventDefault();
    localStorage.removeItem('kirti_admin_app_installed');
    setIsInstalled(false);
  };
  ...
  const handleWhatsAppShare = () => {
    const text = `Kirti College Auditorium Administrator Portal: ${networkInfo.lanUrl}`;
  ...
  return (
    <div style={{
      ...
      <Navbar activePage="Admin Login" />

      <main className="admin-portal-wrapper" style={{ flex: 1 }}>
        ...
        <div className="admin-portal-card">
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <div style={{
              ...
              <ShieldCheck size={14} color="#6366F1" /> Kirti College • Administrator Access Gateway
            </div>

            <h1 className="admin-portal-title">
              Auditorium Administrator Portal
            </h1>

            <p className="admin-portal-subtitle">
              Centralized administrative workspace for venue scheduling, booking approvals, faculty authorization, and institutional audit log management.
            </p>
          </div>
          ...
          <div className="admin-portal-grid">
            ...
            <div className="admin-action-card" style={{
              ...
              <div>
                ...
                <h2 style={{
                  ...
                  {isInstalled
                    ? (isMobile ? 'Launch Admin App' : 'Launch Admin Dashboard')
                    : (isMobile ? 'Install Admin App' : 'Install Administrator App')}
                </h2>
                ...
                <p style={{
                  ...
                  {isInstalled
                    ? 'Administrator app is installed on this device. Click below to launch the dashboard.'
                    : 'Download and install the official admin progressive web app for quick 1-tap management and instant alerts.'}
                </p>
                ...
                <div style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.82rem', color: '#334155', fontWeight: 650 }}>
                    <CheckCircle2 size={16} color="#10B981" /> Venue Scheduling & Maintenance Lock
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.82rem', color: '#334155', fontWeight: 650 }}>
                    <CheckCircle2 size={16} color="#10B981" /> 1-Click System Backup & Restore
                  </div>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, fontSize: '0.82rem', color: '#334155', fontWeight: 650 }}>
                    <CheckCircle2 size={16} color="#10B981" /> Faculty Directory & Access Approval
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                >
                  {isInstalled ? (
                    <>
                      <Play size={16} fill="#FFFFFF" /> Launch Admin Dashboard
                    </>
                  ) : (
                    <>
                      <Download size={16} /> Download & Install Admin App
                    </>
                  )}
                </button>
            ...
            <div className="admin-action-card" style={{
              ...
              <div>
                <div style={{
                  ...
                  <Smartphone size={14} /> Admin Mobile Access
                </div>
                ...
                <h2 style={{
                  ...
                  {isMobile ? 'Share with Admin Staff' : 'Scan to Open on Mobile'}
                </h2>
                ...
                <p style={{
                  ...
                  {isMobile
                    ? 'Share the administrator portal link with authorized administrative staff.'
                    : 'Scan with your smartphone on campus Wi-Fi to install or launch the Admin PWA.'}
                </p>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8, width: '100%' }}>
                ...
                >
                  ...
                  {copied ? 'Link Copied!' : 'Copy Admin URL'}
                </button>
