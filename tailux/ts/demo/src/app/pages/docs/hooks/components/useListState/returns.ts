...
export const returns: ReturnItem[] = [
  ...
  },
  {
    ...
    type: "Object",
    description:
      "An object containing various methods to manipulate the list state.",
  },
  {
  ...
  },
  {
    ...
    type: "function",
    description:
      "Applies a function to each item in the list and returns a new list.",
  },
  {
    name: "handlers.applyWhere",
    type: "function",
    description:
      "Applies a function to items that satisfy a condition and returns a new list.",
  },
  {
  ...
  },
  {
    ...
    type: "function",
    description:
      "Updates a property of an item at a specified index in the list.",
  },
  {
    name: "handlers.setItemPropWhere",
    type: "function",
    description:
      "Updates a property of items that satisfy a condition in the list.",
  },
  {
    name: "handlers.filter",
    type: "function",
    description:
      "Filters the list based on a condition and returns a new list.",
  },
];
