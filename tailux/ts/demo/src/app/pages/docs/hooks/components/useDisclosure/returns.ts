...
export const returns: ReturnItem[] = [
  {
    ...
    type: "boolean",
    description:
      "The current state of the disclosure (true for open, false for closed).",
  },
  {
    name: "handlers",
    type: "object",
    description:
      "An object containing functions for managing the disclosure state.",
  },
  {
    name: "handlers.open",
    type: "function",
  ...
  },
  {
    ...
    type: "function",
    description:
      "A function to toggle the disclosure state between open and closed.",
  },
];
