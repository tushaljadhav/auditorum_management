    ...
    props: [
      {
        ...
        type: "boolean",
        description:
          "Specifies the initial state of the search button (expanded or collapsed).",
      },
      {
        name: "className",
        type: "string",
      ...
      },
      {
        ...
        type: "object",
        description:
          "An object containing properties to customize the button's behavior and appearance.",
      },
    ],
  },
];
