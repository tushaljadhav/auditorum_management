...
export function CreditCard({ balance, image, number }: CreditCardProps) {
  return (
    <div className="relative h-40 w-64 shrink-0 rounded-lg bg-linear-to-br from-[#ffffff55] to-[#ffffff20]">
