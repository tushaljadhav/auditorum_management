        ...
        <THead>
          <Tr>
            {cols.map((title, index) => (
              <Th
                key={index}
                className="bg-gray-200 font-semibold uppercase text-gray-800 first:ltr:rounded-l-lg last:ltr:rounded-r-lg first:rtl:rounded-r-lg last:rtl:rounded-l-lg dark:bg-dark-800 dark:text-dark-100"
              >
                {title}
              </Th>
            ))}
