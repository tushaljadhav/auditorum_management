...
const MenuItem = ({ active, title, onKeyDown, ...rest }) => (
  <li>
    <button
      className={clsx(
        "font-medium tracking-wide cursor-pointer outline-hidden transition-colors",
        active
  ...
  return (
    <Card>
      <div className="border-b border-gray-200 p-4 dark:border-dark-500 sm:px-5">
        <h2 className="truncate font-medium tracking-wide cursor-pointer text-gray-800 dark:text-dark-100 lg:text-base">
          Menu List Example 1
        </h2>
      </div>
