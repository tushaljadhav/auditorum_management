  ...
  return (
    <div className="max-w-2xl space-y-4">
      ...
      >
        <div
          role="alert"
          className="flex flex-col items-center space-y-4 rounded-lg border border-gray-200 p-4 text-gray-800 dark:border-dark-450 dark:text-dark-100 sm:flex-row sm:space-x-2 sm:space-y-0 sm:"
        >
