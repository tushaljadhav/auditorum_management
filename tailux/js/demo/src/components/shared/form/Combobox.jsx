                ...
                >
                  ...
                  >
                    <ComboboxOptions
                      ...
                      className={clsx(
                        "absolute left-(--left-anchor)! w-(--input-width) z-10 max-h-60 overflow-y-auto overflow-x-hidden rounded-lg border border-gray-300 bg-white py-1 shadow-lg shadow-gray-200/50 outline-hidden focus-visible:outline-hidden dark:border-dark-500 dark:bg-dark-750 dark:shadow-none",
                        multiple && "mt-2",
                      )}
                    >
